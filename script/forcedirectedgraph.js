(function (d3) {
    ...
    forcedirect.prototype.redraw = function (callback) {
        ...
        var bulletsRange = p.bulletsRange = p.bullets = (me.bullets ? me.bullets.constructor == Array ? me.bullets.length > 1 ? me.bullets : [5, 50] : [5, 50] || [5, 50] : [5, 50]).sort(function (
            a, b) {
            return a - b
        }), bulletsRange = [bulletsRange.shift(), bulletsRange.pop()];
        var linksRange = p.linksRange = p.links = (me.links ? me.links.constructor == Array ? me.links.length > 1 ? me.links : [1, 5] : [1, 5] || [1, 5] : [1, 5]).sort(function (
            a, b) {
            return a - b
